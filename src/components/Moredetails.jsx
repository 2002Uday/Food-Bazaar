...
const Moredetails = () => {
  return (
    <div className='box-border p-10 bg-white rounded-3xl border-4 border-white shadow-xl'>
      ...
      <div className="space-y-12">
        <div className="border-b border-gray-900/10 pb-12">
          <p className="mt-10 text-xl leading-6 text-gray-600">Add your details where you can receive your Delivery</p>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input
                  ...
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-purple-400 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
