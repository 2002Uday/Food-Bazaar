  ...
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
      <div className='py-2 flex-1 flex flex-col items-start md:items-start justify-center gap-6'>
        <div className='flex items-center gap-2 justify-center bg-purple-500 px-4 py-1 rounded-full'>
        ...
        <p className='text-[2.5rem] lg:text-[4.5rem] font-bold tracking-wide text-gray-800'>
          The Fastest Food Delivery in <span className='text-purple-500 text-[3rem] lg:text-[5rem]'>Your City</span>
        </p>
        ...
        <button type='button' 
        className='bg-gradient-to-br from-purple-500 to-purple-800 text-white md:w-auto w-full px-4 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out duration-100'>Order Now</button>
      </div>
